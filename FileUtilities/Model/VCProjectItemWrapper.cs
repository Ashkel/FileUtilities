...
namespace FileUtilities.Model
{
	abstract class VCProjectItemWrapper
    {
        ...
        public VCProjectWrapper ContainingProject
        {
            get
            {
                return new VCProjectWrapper((VCProject)VCProjectItem.project);
            }
        }
        ...
        public ContainerWrapper Parent
        {
            get
            {
                if (VCProjectItem.Parent == null)
                    ...
                    return (ContainerWrapper)WrapperFactory.FromVCProjectItem((VCProjectItem)VCProjectItem.Parent);
            }
        }
